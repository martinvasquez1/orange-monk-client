...
export default function InputImage({ labelText, setImage }) {
    ...
    <div className="mt-4 w-full">
      ...
      <div className="flex items-center border-b-2 border-base-300 bg-base-200">
        <button
          ...
          className={`flex-1 py-3 ${showInput === true ? 'bg-base-300' : 'hover:bg-base-300/50'}`}
        >
          File
        </button>
        <button
          onClick={() => setShowInput(false)}
          className={`flex-1 py-3 ${showInput === false ? 'bg-base-300' : 'hover:bg-base-300/50'}`}
        >
          URL
        </button>
      </div>
      <div>
        {showInput ? (
          ...
          <div className="flex h-48 w-full justify-center bg-base-200">
